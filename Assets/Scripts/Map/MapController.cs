...
namespace MapSpace
{
	public class MapController
	{
		...
		void InitCoordinates()
		{
			...
			// Круг
			// Нижняя сторона
			_coordinates.Add(0, new Cell(6, -6, Map.Locations.Circle));// Топь 4 выход
			...
			_coordinates.Add(9, new Cell(-3, -6, Map.Locations.Fen)); // Топь 1 вход
			_coordinates.Add(10, new Cell(-4, -6, Map.Locations.Circle));
			_coordinates.Add(11, new Cell(-5, -6, Map.Locations.Circle));
			// Левая сторона
			_coordinates.Add(12, new Cell(-6, -6, Map.Locations.Circle));// Топь 1 выход
			...
			_coordinates.Add(21, new Cell(-6, 3, Map.Locations.Fen)); // Топь 2 вход
			_coordinates.Add(22, new Cell(-6, 4, Map.Locations.Circle));
			_coordinates.Add(23, new Cell(-6, 5, Map.Locations.Circle));
			// Верхняя сторона
			_coordinates.Add(24, new Cell(-6, 6, Map.Locations.Circle));// Топь 2 выход
			...
			_coordinates.Add(33, new Cell(3, 6, Map.Locations.Fen)); // Топь 3 вход
			_coordinates.Add(34, new Cell(4, 6, Map.Locations.Circle));
			_coordinates.Add(35, new Cell(5, 6, Map.Locations.Circle));
			// Правая сторона
			_coordinates.Add(36, new Cell(6, 6, Map.Locations.Circle));// Топь 3 выход
			...
			_coordinates.Add(45, new Cell(6, -3, Map.Locations.Fen)); // Топь 4 вход
			_coordinates.Add(46, new Cell(6, -4, Map.Locations.Circle));
			_coordinates.Add(47, new Cell(6, -5, Map.Locations.Circle));

			// Топь 1
			_coordinates.Add(48, new Cell(-3, -5, Map.Locations.Fen, 1));
			_coordinates.Add(49, new Cell(-4, -5, Map.Locations.Fen, 3));
			_coordinates.Add(50, new Cell(-5, -5, Map.Locations.Fen, 6));
			// Топь 2
			_coordinates.Add(51, new Cell(-5, 3, Map.Locations.Fen, 1));
			_coordinates.Add(52, new Cell(-5, 4, Map.Locations.Fen, 3));
			_coordinates.Add(53, new Cell(-5, 5, Map.Locations.Fen, 6));
			// Топь 3
			_coordinates.Add(54, new Cell(3, 5, Map.Locations.Fen, 1));
			_coordinates.Add(55, new Cell(4, 5, Map.Locations.Fen, 3));
			_coordinates.Add(56, new Cell(5, 5, Map.Locations.Fen, 6));
			// Топь 4
			_coordinates.Add(57, new Cell(5, -3, Map.Locations.Fen, 1));
			_coordinates.Add(58, new Cell(5, -4, Map.Locations.Fen, 3));
			_coordinates.Add(59, new Cell(5, -5, Map.Locations.Fen, 6));

			// Срез 1
			_coordinates.Add(60, new Cell(-2, -4.5f, Map.Locations.Fen));
			_coordinates.Add(61, new Cell(-4.5f, -2, Map.Locations.Fen));
			// Срез 2
			_coordinates.Add(62, new Cell(-4.5f, 2, Map.Locations.Fen));
			_coordinates.Add(63, new Cell(-2, 4.5f, Map.Locations.Fen));
			// Срез 3
			_coordinates.Add(64, new Cell(2, 4.5f, Map.Locations.Fen));
			_coordinates.Add(65, new Cell(4.5f, 2, Map.Locations.Fen));
			// Срез 4
			_coordinates.Add(66, new Cell(4.5f, -2, Map.Locations.Fen));
			_coordinates.Add(67, new Cell(2, -4.5f, Map.Locations.Fen));
			...
			// Трясина
			_coordinates.Add(73, new Cell(0, -1, Map.Locations.Quagmire, 6));
			...
			// Трясина
			_coordinates.Add(79, new Cell(-1, 0, Map.Locations.Quagmire, 6));
			...
			// Трясина
			_coordinates.Add(85, new Cell(0, 1, Map.Locations.Quagmire, 6));
			...
			// Трясина
			_coordinates.Add(91, new Cell(1, 0, Map.Locations.Quagmire, 6));
